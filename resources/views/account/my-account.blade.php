                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('user-profile-information.update') }}">
                                ...
                                <div class="form-group row">
                                    <label for="first_name" class="col-md-4 col-form-label label text-md-right">{{ __('First Name') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="last_name" class="col-md-4 col-form-label label text-md-right">{{ __('Last Name') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="email" class="col-md-4 col-form-label label text-md-right">{{ __('E-Mail Address') }}</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('user-password.update') }}">
                                ...
                                <div class="form-group row">
                                    <label for="current_password" class="col-md-4 col-form-label label text-md-right">{{ __('Current Password') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="password" class="col-md-4 col-form-label label text-md-right">{{ __('Password') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="password-confirm" class="col-md-4 col-form-label label text-md-right">{{ __('Confirm Password') }}</label>
